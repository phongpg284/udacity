...
![Visualization of what we would like our priority queue to look like, with the lowest frequency node on the left, 'D'-2, followed by 'B'-3, 'E'-6, 'A'-7, and finally the highest frequency node on the right, 'C'-7.](https://video.udacity-data.com/topher/2020/May/5eac5f84_screenshot-2020-04-27-at-5.15.56-pm/screenshot-2020-04-27-at-5.15.56-pm.png)
...
![Visualization of the tseps described above to build a Huffman tree from a priority queue.](https://video.udacity-data.com/topher/2020/May/5eac5fd2_huffman-tree-1/huffman-tree-1.png)

![Visualization of repeating steps 3 and 4 above to create a Huffman tree.](https://video.udacity-data.com/topher/2020/May/5eac5feb_huffman-tree-2/huffman-tree-2.png)
...
![The resulting Huffman tree from the given priority queue.](https://video.udacity-data.com/topher/2020/May/5eac6028_huffman-tree-3/huffman-tree-3.png)
...
![Block chain with 3 blocks, 'Block 0', 'Block 1' which refers to 'Block 0', and 'Block 2' which refers to 'Block 1'](https://video.udacity-data.com/topher/2019/April/5ca8bd1d_untitled-diagram/untitled-diagram.png)
